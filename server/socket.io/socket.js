...
const markAsReadGroup = require("./utilities/markAsReadGroup");
...
module.exports = (io) => {
  ...
  io.on("connection", (socket) => {
    ...
    socket.on("markAsReadGroup", async (_id, receiver) => {
      try {
        await markAsReadGroup(socket, _id, receiver, onlineUsers);
      } catch (error) {
        console.log(error);
      }
    });
